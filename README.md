...
class SettingsPage(tk.Frame):
    def __init__(self, parent, controller: KidsGameApp):
        ...
        tk.Label(self, text="High Scores", font=("Helvetica", 16, "underline"), bg="#fffaf6").pack(pady=(12, 6))
...
class GamePage(tk.Frame):
    ...
    def next_round(self):
        self.rounds += 1
        # update level every 5 rounds
        self.level = 1 + (self.rounds - 1) // 5
    ...
    def do_correct(self):
        ...
        self.canvas.create_text(380, 180, text="★", font=("Helvetica", 80), fill="#ffd700")
